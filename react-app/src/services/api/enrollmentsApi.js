// API service for enrollments - replaces Firestore calls
...
// Real-time subscriptions not available with REST API
// Frontend will need to poll or use WebSockets if real-time is needed
